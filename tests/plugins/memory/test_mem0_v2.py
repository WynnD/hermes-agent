...
class TestMem0FiltersV2:
    ...
    def test_self_hosted_sync_turn_stores_verbatim(self, monkeypatch):
        client = FakeClientV2()
        provider = self._make_provider(monkeypatch, client)
        provider._base_url = "https://mem0.example.test"
...
class TestMem0Defaults:
    ...
    def test_base_url_makes_provider_available_without_api_key(self, monkeypatch, tmp_path):
