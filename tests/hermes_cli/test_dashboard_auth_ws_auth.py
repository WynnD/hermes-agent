...
@pytest.mark.asyncio
async def test_legacy_api_auth_uses_scope_path_not_url_path(loopback_app):
    """Host-header poisoning must not make an /api request look public."""
    request = SimpleNamespace(
        app=web_server.app,
        scope={"path": "/api/not-public"},
    ...
    response = await web_server.auth_middleware(request, call_next)
